...
const cycle = (index, kind, overrides = {}) => ({
  ...
  breakdown: {
    windowCreateInvokeMs: 40,
    fixedSettleDelayMs: 1_510,
    previewRuntimeBootstrapMs: 10_280,
    previewRuntimeReadyMs: 60,
    bootstrapLoopOverheadMs: 10_220,
    loadAndStartMs: 260,
  },
  bootstrapDetail: {
    deadlineMs: 10_000,
    pollPeriodMs: 500,
    iterations: 20,
    exitReason: "deadline-exhausted",
    readyPromiseResolved: true,
    readinessConsumedByBackgroundDrain: true,
  },
  marks: {},
  ...overrides,
});

// PROOF-only preview runtime extension.
//
...
import { createProofExpectationRegistry } from "./Issue21EndpointsProof.js";

globalThis.__playgroundPreviewExtension = controls => {
  const realmToken = controls.realmToken;
  ...
  return {
    ...
    bootstrap: {
      ...
      bridgeAction: executeBridgeAction,
    },
  };
};

// Issue 049 — Output panel: managed/native output + runtime failures.
//
...
export interface Issue049OutputPanel {
...
let installed: Issue049OutputPanel | null = null;
 ...
 */
export function installIssue049OutputPanel(): Issue049OutputPanel {
 ...
 */
export function getIssue049OutputPanel(): Issue049OutputPanel {
  return installed ?? installIssue049OutputPanel();
}

export default installIssue049OutputPanel;
